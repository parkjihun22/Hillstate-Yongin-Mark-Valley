  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        {/* SEO 최적화를 위한 메타 태그 */}
        <title>힐스테이트 용인 마크밸리 - 공급안내</title>
        <meta
          name="description"
        ...
        <script type="application/ld+json">
          {`	{		"@context": "https://schema.org",		"@type": "WebPage",		"name": "힐스테이트 용인 마크밸리 - 공급안내",		"description": "힐스테이트 용인 마크밸리의 인터넷 청약은 간편하고 빠르게 분양에 참여할 수 있는 방법을 제공합니다. 온라인을 통해 청약 절차를 빠르게 진행하며, 언제 어디서든 쉽게 신청 가능합니다. 청약 전 반드시 필요한 정보와 절차를 확인하고, 청약을 통해 힐스테이트 용인 마크밸리의 기회를 놓치지 마세요.",		"url": "https://www.alwatanyh.com/SalesInfo/guide"	}	`}
        </script>
      </Helmet>
