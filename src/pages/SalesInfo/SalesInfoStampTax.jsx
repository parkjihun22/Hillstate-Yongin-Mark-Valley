...
const ComplexGuide1 = () => {
  ...
  return (
    <div className={styles.container}>
      <Helmet>
        <title>힐스테이트 양산더스카이 - 인지세 안내</title>
        <meta
          name="description"
          content="힐스테이트 양산더스카이 인지세 안내 페이지입니다. 계약서 작성 시 부과되는 인지세의 세액과 납부 절차를 확인하세요."
        />
        <link rel="canonical" href="https://www.alwatanyh.com/SalesInfo/stampTax" />

        {/* Open Graph */}
        <meta property="og:title" content="힐스테이트 양산더스카이 - 인지세 안내" />
        <meta
      ...
      <p className={styles.screenReaderOnly}>
        힐스테이트 양산더스카이의 인지세 안내 페이지는 분양과 관련된 세금
