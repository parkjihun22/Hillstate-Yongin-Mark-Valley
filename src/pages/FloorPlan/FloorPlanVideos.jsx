...
const FloorPlanVideos= () => {
  ...
  return (
    <div className={styles.container}>
                    ...
                    <meta name="description" content="세대안내영상 안내 페이지는 평택브레인시티푸르지오의 각 아파트 세대안내영상를 제공합니다. 고객들이 아파트의 구조를 정확히 이해하고, 자신의 생활 스타일에 맞는 평형을 선택할 수 있도록 돕습니다. 다양한 평면 설계를 확인하고 자신에게 맞는 최적의 공간을 찾아보세요." />
                    <meta property="og:title" content="평택브레인시티푸르지오 - 세대안내영상" />
                    <meta property="og:description" content="세대안내영상 안내 페이지는 평택브레인시티푸르지오의 각 아파트 세대안내영상를 제공합니다. 고객들이 아파트의 구조를 정확히 이해하고, 자신의 생활 스타일에 맞는 평형을 선택할 수 있도록 돕습니다. 다양한 평면 설계를 확인하고 자신에게 맞는 최적의 공간을 찾아보세요." />
                    ...
                    <meta name="twitter:title" content="평택브레인시티푸르지오 - 세대안내영상" />
                    <meta name="twitter:description" content="세대안내영상 안내 페이지는 평택브레인시티푸르지오의 각 아파트 세대안내영상를 제공합니다. 고객들이 아파트의 구조를 정확히 이해하고, 자신의 생활 스타일에 맞는 평형을 선택할 수 있도록 돕습니다. 다양한 평면 설계를 확인하고 자신에게 맞는 최적의 공간을 찾아보세요." />
      ...
      <h1 className={styles.screenReaderOnly}>평택브레인시티푸르지오 - 홍보영상</h1>
			<p className={styles.screenReaderOnly}>세대안내영상 안내 페이지는 평택브레인시티푸르지오의 각 아파트 세대안내영상를 제공합니다. 고객들이 아파트의 구조를 정확히 이해하고, 자신의 생활 스타일에 맞는 평형을 선택할 수 있도록 돕습니다. 다양한 평면 설계를 확인하고 자신에게 맞는 최적의 공간을 찾아보세요.
			</p>
