  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        {/* SEO 최적화를 위한 메타 태그 */}
        <title>힐스테이트 도안리버파크 - 평면안내 </title>
        <meta
          name="description"
          content=" 힐스테이트 도안리버파크의 평면도를 통해 세대별 구조와 공간 활용도를 확인하세요. 실용적이고 혁신적인 설계를 기반으로 한 다양한 평면 구성이 여러분의 생활을 더 편리하게 만듭니다."
        />
        <meta
          name="keywords"
        ...
        <script type="application/ld+json">
          {`	{		"@context": "https://schema.org",		"@type": "WebPage",		"name": "힐스테이트 도안리버파크 -  평면안내",		"description": " 힐스테이트 도안리버파크의 평면도를 통해 세대별 구조와 공간 활용도를 확인하세요. 실용적이고 혁신적인 설계를 기반으로 한 다양한 평면 구성이 여러분의 생활을 더 편리하게 만듭니다.",		"url": "https://www.alwatanyh.com/FloorPlan/59A"	}	`}
        </script>
      </Helmet>
      ...
      <p className={styles.screenReaderOnly}>
        59타입의평면 안내 페이지는 힐스테이트 도안리버파크의 각 아파트 평면도를
      ...
      <img
				...
				src={page1}
				alt="힐스테이트 도안리버파크 84A타입의평면안내-image1"
