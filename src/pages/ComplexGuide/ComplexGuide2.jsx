...
const ComplexGuide1 = () => {
	...
	return (
		<div className={styles.container}>
			...
			<Helmet>
				<title>평택브레인시티푸르지오 - 호수배치도</title>
				<meta name="description" content="평택브레인시티푸르지오의 호수 배치도를 통해 각 세대의 위치와 전망을 확인하세요. 주거 만족도를 높이는 체계적인 배치 설계로 더 나은 라이프스타일을 제안합니다." />
				<meta property="og:title" content="평택브레인시티푸르지오 - 호수배치도" />
				<meta property="og:description" content="평택브레인시티푸르지오의 호수 배치도를 통해 각 세대의 위치와 전망을 확인하세요. 주거 만족도를 높이는 체계적인 배치 설계로 더 나은 라이프스타일을 제안합니다." />
				...
				<meta name="twitter:title" content="평택브레인시티푸르지오 - 호수배치도" />
				<meta name="twitter:description" content="평택브레인시티푸르지오의 호수 배치도를 통해 각 세대의 위치와 전망을 확인하세요. 주거 만족도를 높이는 체계적인 배치 설계로 더 나은 라이프스타일을 제안합니다." />
			...
			<h1 className={styles.screenReaderOnly}>평택브레인시티푸르지오 - 호수배치도</h1>
