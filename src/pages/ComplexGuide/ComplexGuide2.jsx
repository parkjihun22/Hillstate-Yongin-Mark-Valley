...
const ComplexGuide1 = () => {
  ...
  return (
    <div className={styles.container}>
      <Helmet>
        <title>힐스테이트 양산더스카이 - 호수배치도</title>
        <meta
          name="description"
          content="힐스테이트 양산더스카이 동·호수 배치도를 통해 단지 구조와 편의시설 위치를 확인하세요."
        />
        <link
          rel="canonical"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="힐스테이트 양산더스카이 - 호수배치도" />
        <meta
