...
const ComplexGuide1 = () => {
	...
	return (
		<div className={styles.container}>
					...
					<Helmet>
					<title>평택브레인시티푸르지오 - 단지배치도</title>
					<meta name="description" content="평택브레인시티푸르지오의 단지 배치도를 통해 각 동의 위치와 편의시설의 배치를 확인하세요. 효율적인 동선 설계와 조경 공간, 입주민의 생활 편의를 고려한 배치를 상세히 안내합니다." />
					<meta property="og:title" content="평택브레인시티푸르지오 - 단지배치도" />
					<meta property="og:description" content="평택브레인시티푸르지오의 단지 배치도를 통해 각 동의 위치와 편의시설의 배치를 확인하세요. 효율적인 동선 설계와 조경 공간, 입주민의 생활 편의를 고려한 배치를 상세히 안내합니다." />
					...
					<meta name="twitter:title" content="평택브레인시티푸르지오 - 단지배치도" />
					<meta name="twitter:description" content="평택브레인시티푸르지오의 단지 배치도를 통해 각 동의 위치와 편의시설의 배치를 확인하세요. 효율적인 동선 설계와 조경 공간, 입주민의 생활 편의를 고려한 배치를 상세히 안내합니다." />
            ...
            <h1 className={styles.screenReaderOnly}>평택브레인시티푸르지오 - 단지배치도</h1>
			<p className={styles.screenReaderOnly}>단지 배치도 페이지는 평택브레인시티푸르지오의 전체 단지 구성도를 제공합니다. 아파트 단지 내 세대 배치, 공용 시설, 주차 공간 등을 시각적으로 보여주어 입주자들이 공간 배치에 대해 명확하게 이해할 수 있도록 돕습니다. 이 배치도를 통해 단지 내 생활을 더 쉽게 계획할 수 있습니다.
			</p>
