	...
	return (
		<div className={styles.container}>
			...
			<Helmet>
				...
				<meta
					name="description"
					content="힐스테이트 용인마크밸리의 사업개요를 통해 프로젝트의 비전과 가치를 확인하세요. 단지 설계, 개발 목표, 주변 환경과의 조화 등을 중점적으로 설명하여 평택에서의 새로운 주거 중심지로서의 가능성을 보여드립니다."
				/>
				<meta
					name="keywords"
				...
				<script type="application/ld+json">
					{`
					{
						...
						"description": "힐스테이트 용인마크밸리의 사업개요를 통해 프로젝트의 비전과 가치를 확인하세요. 단지 설계, 개발 목표, 주변 환경과의 조화 등을 중점적으로 설명하여 평택에서의 새로운 주거 중심지로서의 가능성을 보여드립니다.",
